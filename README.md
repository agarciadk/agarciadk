![BannerGIF](https://github.com/agarciadk/agarciadk/assets/4200145/e76b360e-0bdc-4ad4-8ca5-bb91ebccf09a)
...
![version :22.08.2026](https://img.shields.io/badge/version-22.08.2026-informational?style=for-the-badge) &nbsp;
...
const alberto = {
  ...
  experience: {
    current: 'Minsait',
    focus: ['Frontend Development', 'Web Components']
  },

  education: {
    degree: 'Software & Computer Engineering',
  ...
  hobbies: ['🏋️ Gym', '📚 Fantasy books', '👾 Videogames'],
...
![LitElement](https://img.shields.io/badge/Lit_Element-169DDC?style=for-the-badge&logo=lit&logoColor=white)&nbsp;
